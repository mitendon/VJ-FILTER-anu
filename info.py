...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Miten_groupbot')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Miten_groupbot')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Miten_groupbot/65')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello  ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001998815924'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@miten_group')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "Hey {mention}👋\n\n{file_name}\n\n🔘 size - {file_size}\n\n╭─── • ❰ @miten_group❱ • ────➤\n┣ ▫️ @miten_Bot/n┣ ▫️ @miten_group/n╰─────── • ◆ • ───────➤")
...
URL = "https://vj-filter-anu.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-filter-anu.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vj-filter-anu.onrender.com".format(FQDN)
else:
    URL = "https://vj-filter-anu.onrender.com/".format(FQDN)
