...
BOT_TOKEN = environ.get('BOT_TOKEN', "6770088977:AAFANc5Lk1so16ap7STTPlQMuXUhW83asLc")
...
URL = "https://d-office-robot-6zaw.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://d-office-robot-6zaw.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://d-office-robot-6zaw.onrender.com".format(FQDN)
else:
    URL = "https://d-office-robot-6zaw.onrender.com/".format(FQDN)
